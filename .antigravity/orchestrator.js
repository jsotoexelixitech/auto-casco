...
function runOrchestrator() {
  ...
  console.log(`[Orchestrator: auto_casa_inspeccion] Initializing ${agentType} agent...`);
  console.log(`Scope confined strictly to: C:\Users\javier.soto\Desktop\auto-casa-inspeccion`);
