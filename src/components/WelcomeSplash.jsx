...
/**
 * Pantalla de bienvenida animada — La Mundial de Seguros.
 * Se muestra durante VISIBLE_MS ms y luego hace fade-out.
 * Puede cerrarse con Escape / Enter / Espacio o con el botón "Omitir".
 */
export function WelcomeSplash() {
  ...
  return (
    <div
      ...
      style={{
        animation: leaving
          ? `splashFadeOut ${FADE_MS}ms ease-out forwards`
          : undefined,
      }}
    >
      {/* Fondo con gradientes de marca */}
      <div
        className="absolute inset-0"
        style={{
          background: 'linear-gradient(135deg, #EAF1FB 0%, #FFFFFF 45%, #FCEFEF 100%)',
        }}
      />
      <div
      ...
      <div className="relative flex flex-col items-center text-center px-6">
        ...
        <div className="relative w-[180px] h-[180px] sm:w-[220px] sm:h-[220px] grid place-items-center">
          ...
          <span
            ...
            style={{
              background: `
                radial-gradient(circle at 30% 30%, ${BRAND.blueLight}44, transparent 60%),
                radial-gradient(circle at 75% 70%, ${BRAND.red}33,       transparent 65%)
              `,
        ...
        <div className="mt-7 sm:mt-9">
          ...
          >
            Inspección digital de vehículos. Seguro, rápido y sin papeleo.
          </p>

          {/* Línea decorativa navy → rojo */}
          <div
